...
{
    fprintf(stderr, "ENTER LoadEncodingManifest\n"); fflush(stderr);
    ...
    {
        fprintf(stderr, "FAIL CopyEKeyEntry\n"); fflush(stderr);
...
{
    fprintf(stderr, "ENTER LoadCascStorage\n"); fflush(stderr);
...
{
    printf("ENTER CascOpenStorageEx\n");
    fprintf(stderr, "ENTER CascOpenStorageEx\\n"); fflush(stderr);
...
{
    printf("ENTER CascOpenStorage\n");
    fprintf(stderr, "ENTER CascOpenStorage\n"); fflush(stderr);
